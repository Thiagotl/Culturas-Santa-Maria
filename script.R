...
ggplot(data = dados,aes(x = Cultura, y = Quantidade))+
  ...
  labs (title = "Culturas Permanentes Santa Maria/RS - Ano de 2020",
        x = "Cultura",
        y = "Quantidade (t)",
        color = "Culturas") +
...
ggplot(data = dados1,aes(x = Cultura, y = Quantidade))   +
  geom_bar(stat="identity",  fill = "steelblue") +
  geom_text(aes(label=Quantidade), vjust = -0.2) +
  labs (title = "Culturas Rotativas Santa Maria/RS - Ano de 2020",
        x = "Cultura",
        y = "Quantidade (t)",
        color = "Culturas") +
  theme(plot.title = element_text(hjust = 0.5, size = 13))
...
ggplot(data = dados2, aes(x = Ano))+
  ...
  labs (title = "Produção de Arroz e Soja nos anos de 1974 a 2020 - Santa Maria/RS",
        x = "Anos",
        y = "Quantidade (t)",
        color = "Culturas") +
